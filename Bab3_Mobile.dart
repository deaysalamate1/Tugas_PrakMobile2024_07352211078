...
import 'package:flutter_application_1/bab4_spash.dart';
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: const Color.fromARGB(77, 49, 39, 39),
                  width: 1), // Black border with width 2
            ),
          ),
        ],
      ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          colors: [
            Color.fromARGB(255, 142, 73, 156),
            Color.fromARGB(255, 161, 74, 198)
          ],
        ),
      ),
      child: Row(
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: const Color.fromARGB(255, 175, 85, 191),
          ),
          child: Text(
            title,
...
class FreelancerList extends StatelessWidget {
  final List<Map<String, dynamic>> freelancers = [
    ...
    },
    {
      ...
      "rating": 4.9,
      "image": "assets/images/skintint.jpg"
    },
    {
      "name": "Larista",
      "profession": "Beautician",
      "rating": 4.9,
      "image": "assets/images/lip_tint.jpg"
    },
    {
      "name": "Elora",
      "profession": "Influenzer",
      "rating": 4.9,
      "image": "assets/images/cushion_sm.jpg"
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const SizedBox(height: 10),
        ServiceCard(
          imageUrl: 'assets/images/cushion_sm.jpg',
          name: 'CUSHION HOOMAN BREATHABLE',
          role: 'Beautician',
          description: 'Doloribus saepe aut necessitatibus qui.',
          rating: 4.9,
        ),
        ServiceCard(
          imageUrl: 'assets/images/skintint.jpg',
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          role,
                          style: const TextStyle(
                            color: Color.fromARGB(166, 153, 112, 164),
                            fontSize: 12,
                          ),
                        ),
                        ...
                        Row(
                          children: [
                            const Icon(Icons.star,
                                color: Color.fromARGB(255, 244, 241, 22),
                                size: 20),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            const Color.fromARGB(255, 177, 135, 224),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          colors: [
            Color.fromARGB(255, 165, 83, 178),
            Color.fromARGB(255, 203, 162, 214)
          ],
        ),
      ),
      child: Row(
...
class BestBooking2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        BestBookingCard(
          imageUrl: 'assets/images/nct.png',
          profileUrl: 'assets/images/lip.jpg',
          name: 'Miss Zachary Will',
          role: 'Beautician',
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 14,
                          color: const Color.fromARGB(255, 198, 162, 207),
                        ),
                      ),
                      SizedBox(height: 4),
                      Text(
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.star,
                          color: const Color.fromARGB(255, 236, 217, 47),
                          size: 16),
                      SizedBox(width: 4),
                      Text(
                        rating.toString(),
                        style: TextStyle(
                          color: const Color.fromARGB(255, 179, 78, 230),
                          fontWeight: FontWeight.bold,
                        ),
                      ),
                    ],
            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/skintint.jpg', // Ganti dengan path gambar Anda
                    height: 200,
                    width: double.infinity,
                    fit: BoxFit.cover,
                  ),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.star,
                            color: const Color.fromARGB(255, 238, 221, 65),
                            size: 16),
                        SizedBox(width: 4),
                        Text(
                          "4.9",
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Beautician",
                    style: TextStyle(
                      color: const Color.fromARGB(255, 184, 167, 183),
                      fontSize: 12,
                    ),
                  ),
                  SizedBox(height: 8),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            const Color.fromARGB(255, 217, 135, 232),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(8),
                        ),
                      ),
                      ...
                      child: Text(
                        "Book Workshop",
                        style: TextStyle(
                            color: const Color.fromARGB(255, 109, 130, 131)),
                      ),
                    ),
                  ),
                ],
